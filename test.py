...
class AStarTest(astar_cpp.AStar):
...
#	print(solve_maze())
	...
	for i in range(1000):
		...
		astar_test = AStarTest()
		astar_test.lines = m.strip().split('\n')
		astar_test.width = len(astar_test.lines[0])
		astar_test.height = len(astar_test.lines)
		astar_test.goal = goal

		start_time = time.time()
		foundPath = astar_test.find_path(start)
		time_astar_cpp += time.time() - start_time
